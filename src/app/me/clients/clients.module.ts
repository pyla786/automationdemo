...
@NgModule({
  declarations: [ClientsComponent, GridViewComponent, MapViewComponent, ProjectsDialogComponent, AddClientDialogComponent, GridColumnsJobsComponent, IssueDialogComponent, UploadExcelComponent],
  imports: [
    CommonModule,
