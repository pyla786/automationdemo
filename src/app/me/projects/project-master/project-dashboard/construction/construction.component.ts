...
import { DriveurldialogComponent } from './driveurldialog/driveurldialog.component';
...
export class ConstructionComponent implements OnInit {
  ...
  opendriveurlDialog(add) {
    let dialogRef = this.dialog.open(DriveurldialogComponent, {
      data: add,
      height: 'auto',
      width: '600px'
    });
